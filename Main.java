...
public class Main {
    public static void main(String[] args) {
        ...
        academia.addFuncionario(new Funcionario("Ester rodrigues", "556.011.490-11", "33.913.647-9", "Ester.rodrigues@gmail.com", "+55(45)99721-66526", "08/09/1976", "personal treiner", "10.000R$", null, null));
        academia.addAparelho(new Aparelho("supino inclinado com alteres", "peitoral clavicular", null, null, "muito difícil"));

        Aparelho supinoInclinadoComAlteres = academia.buscarAparelhoPorNome("supino inclinado com alteres");
